angular.module('iwx')
	.controller('ActivityUniversityCtrl', function ($scope, $rootScope, $http, ngTableParams, eventType, $modal, $state, userService) {
	        ...
	        $modal.open({
	        	...
	        	controller: ['$scope', '$modalInstance', function ($scope, $modalInstance) {
	                ...
	                $scope.ok = function () {
	                    ...
	                    $http.post('/api/un/' + activity_id + '/unpublish', { content: $scope.content })
	                        .success(function (data) {
