angular.module('iwx')
	.controller('CommAddDepMemCtrl', function ($scope, $rootScope, $http, ngTableParams, $modalInstance, eventType, department) {
		...
		$scope.tableParams = new NgTableParams({
			...
			getData: function ($defer, params) {
				$http.get('/api/admin/department/users?page='+params.page()+'&per_page='+params.count())
	    ...
	    $scope.choose_member = function () {
	    	...
	    	$http.post('/api/admin/department/' + $scope.department.id + '/add_department', param)
	    		.success(function (data) {
	    			$rootScope.$emit(eventType.NOTIFICATION, {
		    			'type': 'POPMSG',
	                    'title': '消息',
